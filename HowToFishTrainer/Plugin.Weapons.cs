    ...
    public partial class Plugin
    {
        ...
        private void EnsureTemplateCandidates()
        {
            ...
            try
            {
                ...
                {
                    var weapon = item != null ? item.Weapon : null;
                ...
                if (preferred < 0)
                {
                    preferred = _templateCandidates
                        .Select((item, idx) => (idx, kick: KickMagnitude(ReadRecoil(GetBarrels(item.Weapon)[0]))))
                        .OrderBy(t => t.kick)
                        .First().idx;
                }
        ...
        private void SelectTemplate(int index)
        {
            ...
            var weapon = _templateCandidates[index].Weapon;
